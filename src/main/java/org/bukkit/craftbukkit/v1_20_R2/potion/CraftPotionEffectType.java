...
public class CraftPotionEffectType extends PotionEffectType {
    ...
    public CraftPotionEffectType(MobEffect handle) {
        super(BuiltInRegistries.MOB_EFFECT.getId(handle) + 1, org.bukkit.craftbukkit.v1_20_R2.util.CraftNamespacedKey.fromMinecraft(BuiltInRegistries.MOB_EFFECT.getKey(handle)));
        this.handle = handle;
    }
