...
public class CraftLivingEntity extends CraftEntity implements LivingEntity {
    ...
    public net.minecraft.world.phys.EntityHitResult rayTraceEntity(int maxDistance, boolean ignoreBlocks) {
        //net.minecraft.world.phys.EntityHitResult rayTrace = getHandle().getTargetEntity(maxDistance); // Banner TODO fixme
        /*
        if (rayTrace == null) {
            return null;
        }
    ...
    public <T extends Projectile> T launchProjectile(Class<? extends T> projectile, Vector velocity) {
        ...
        if (Snowball.class.isAssignableFrom(projectile)) {
            ...
            if (TippedArrow.class.isAssignableFrom(projectile)) {
                ...
                ((Arrow) launch).setBasePotionType(PotionType.WATER);
